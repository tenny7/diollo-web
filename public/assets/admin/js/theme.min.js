...
var Demo = function() {
    var n = document.querySelector("#demoForm")
      ...
      , p = (document.querySelectorAll("#stylesheetLight, #stylesheetDark"),
    ...
    document.addEventListener("DOMContentLoaded", function() {
        var a, e, t, o, r, l;
        "light" == (a = colorScheme) ? (p.disabled = !1,
        h.disabled = !0) : "dark" == a && (p.disabled = !0,
        h.disabled = !1),
        function(a) {
            if (s && i && c && d)
                if ("topnav" == a) {
        ...
        e = v,
        c && ("default" == e ? (c.classList.remove("navbar-dark", "bg-vibrant"),
        c.classList.add("navbar-light")) : "vibrant" == e && (c.classList.remove("navbar-light"),
        c.classList.add("navbar-dark", "bg-vibrant"))),
        t = n,
        o = colorScheme,
        r = b,
        l = v,
        $(t).find('[name="colorScheme"][value="' + o + '"]').closest(".btn").button("toggle"),
        $(t).find('[name="navPosition"][value="' + r + '"]').closest(".btn").button("toggle"),
        $(t).find('[name="sidebarColor"][value="' + l + '"]').closest(".btn").button("toggle"),
  ...
  , Orders = function() {
    var a, e, t = $("#ordersChart"), o = $('[name="ordersSelect"]');
    t.length && (a = t,
    e = new Chart(a,{
        type: "bar",
        options: {
    ...
    r = new Chart(o,{
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: ['#ff0066', '#ff99cc', ThemeCharts.colors.primary[100]],
  ...
  , Dropdowns = function() {
    ...
    $(".dropdown-menu .dropdown-toggle").on("click", function() {
        var a;
        return (a = $(this)).closest(e).siblings(e).find(t).removeClass("show"),
    ...
    e.on("hide.bs.dropdown", function() {
        var a, e;
        a = $(this),
        (e = a.find(o)).length && e.removeClass("show")
    })
}()
  , Dropzones = function() {
    var a = $('[data-toggle="dropzone"]')
      , l = $(".dz-preview");
    a.length && (Dropzone.autoDiscover = !1,
    a.each(function() {
        var a, e, t, o, r;
        a = $(this),

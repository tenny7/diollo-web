                                ...
                                <div class="col-auto">
                                    ...
                                    <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="bulkActionDropdown">
                                                <button class="dropdown-item admindeleteBrandAction" id="admindeleteBrandAction">Delete</button>
                                            </div>
                                        </div>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a href="{{route('admin.brand.showBrandUpdate',$brand->id)}}" class="dropdown-item">
                                                      Edit Brand
                                                    </a>

                                        ...
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a href="{{ route('customer.productPage',$product->id)}}" class="dropdown-item">
                                                      View Product
                                                    </a>
                                                <a href="{{ route('admin.products.updateForm', $product->slug) }}" class="dropdown-item">
                                                      Edit Product
                                                    </a>
                                                <a href="{{ route('admin.products.addFeatured',$product->slug) }}" class="dropdown-item">
                                                      Add to featured
                                                    </a>
                                                    <a href="{{ route('admin.products.addClearance',$product->slug) }}" class="dropdown-item">
                                                      Add to Clearance Sales
                                                    </a>
                                                    <a href="{{ route('admin.products.delete',$product->slug) }}" class="dropdown-item">
                                                      Delete Product
                                                    </a>
                                                </div>
                                            </div>

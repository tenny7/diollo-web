                                    ...
                                    <ul class="nav nav-tabs nav-overflow header-tabs">
                                        <li class="nav-item">
                                            <a href="products-all.html" class="nav-link">
                                              All <span class="badge badge-pill badge-soft-secondary">7</span>
                                            </a>
                                        </li>

                                        <li class="nav-item">
                                            <a href="products-all.html" class="nav-link active">
                                                Active <span class="badge badge-pill badge-soft-secondary">5</span>
                                            </a>
                                        </li>

                                        <li class="nav-item">
                                            <a href="products-all.html" class="nav-link">
                                                Complete <span class="badge badge-pill badge-soft-secondary">2</span>
                                            </a>
                                        </li>

        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-12 col-lg-10 col-xl-8">
                    ...
                    <!-- Form -->
                <form class="mb-4" method="post" action="{{ route('admin.promotions.update', $promotion->id) }}">
                    @csrf
                        <div class="row">
                            <div class="col-12">
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <!-- Input -->
                                    <input type="text" value="{{ $promotion->started }}" class="form-control" placeholder="Enter start date" name="started" data-toggle="flatpickr" required>

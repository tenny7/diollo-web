                    ...
                    <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <!-- Input -->
                                    <input type="text" name="bussiness_phone" class="form-control mb-3" placeholder="(+234)_______-____" data-mask="(+234) 00000000000" autocomplete="off" maxlength="18">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <!-- Input -->
                                    <input type="text" name="bussiness_email" class="form-control">
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="opening_hours" class="form-control" placeholder="8am - 6pm, Monday to Saturday">
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="street_address" class="form-control" placeholder="229 Maitama">
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-auto">
                                            ...
                                            <input type="color" name="store_background_color" value="#f6b73c">

    ...
    <div class="main-content">
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                ...
                <!-- Form -->
                <form class="mb-4" method="post" action="{{ route('admin.vendors.addVendorToStore') }}">
                    @csrf
                        <div class="row">
                            <div class="col-6">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <input type="text" class="form-control" name="store" id="store" value="{{ $store->name }}">

                                    {{-- <select name="store" id="store" class="form-control">
                                        <option value="1">Eni stores</option>
                                    </select> --}}

                ...
                <div class="col-12">
                    ...
                    <div class="card" data-toggle="lists" data-lists-values="[&quot;orders-order&quot;, &quot;orders-product&quot;, &quot;orders-date&quot;, &quot;orders-total&quot;, &quot;orders-status&quot;, &quot;orders-method&quot;]">
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm table-nowrap card-table" id="history-datatable">
                            ...
                            &nbsp;
                                ...
                                @foreach($user->refferalrelationships as $referredUser)
                                    ...
                                    <tr>
                                        ...
                                        <td class="vendors-name" colspan="2">
                                            {{-- @php
                                                $uume = $referral->relationships
                                                $downliner = \App\Models\User::find($myDownliner->user_id);
                                                echo $downliner->fullname;
                                            @endphp

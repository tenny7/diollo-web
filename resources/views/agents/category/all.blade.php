                                ...
                                <div class="col">
                                    ...
                                    <ul class="nav nav-tabs nav-overflow header-tabs">
                                        <li class="nav-item">
                                            ...
                                            All <span class="badge badge-pill badge-soft-secondary">{{ count($categories)}}</span>
                                            </a>
                                        </li>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a href="{{route('agent.category.showCategoryUpdate',$category->id)}}" class="dropdown-item">
                                                      Edit Category
                                                    </a>

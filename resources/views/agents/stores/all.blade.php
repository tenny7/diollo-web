                    ...
                    <div class="header mt-md-5">
                        <div class="header-body">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto">
                                <a href="{{route('agent.stores.new')}}" class="btn btn-primary">
                                        New Store
                                    </a>
                                </div>
                            </div>
                            ...
                            <!-- <table class="table table-sm card-table"> -->
                                ...
                                <tbody class="list">
                                    ...
                                    <tr>
                                        ...
                                        @if($store->vendor->isActive())
                                        <td class="vendors-status">
                                                <div class="badge badge-soft-success">
                                                    active
                                                </div>
                                            </td>
                                        @elseif($store->vendor->isInactive()) 
                                        <td class="vendors-status">
                                                <div class="badge badge-soft-success">
                                                    suspended
                                                </div>
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <a href="{{ route('agent.stores.showUpdateForm',$store->id)}}" class="dropdown-item">
                                                        Edit Store
                                                    </a>
                                                <a href="{{ route('agent.vendors.new',$store->id) }}" class="dropdown-item">
                                                        Add Vendor
                                                    </a>
                                                    {{-- <a href="{{ route('agent.agents.new',$store->id) }}" class="dropdown-item">
                                                        Add Agent
                                                    </a> --}}
                                                </div>

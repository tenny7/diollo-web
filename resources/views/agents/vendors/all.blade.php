                ...
                <div class="col-12">
                                ...
                                <div class="col">
                                    ...
                                    <ul class="nav nav-tabs nav-overflow header-tabs">
                                        <li class="nav-item">
                                            ...
                                            All <span class="badge badge-pill badge-soft-secondary">{{ count($vendors)}}</span>
                                            </a>
                                        </li>
                    ...
                    <div class="card" data-toggle="lists" data-lists-values="[&quot;orders-order&quot;, &quot;orders-product&quot;, &quot;orders-date&quot;, &quot;orders-total&quot;, &quot;orders-status&quot;, &quot;orders-method&quot;]">
                      ...
                      <div class="dropdown-menu dropdown-menu-right" aria-labelledby="bulkActionDropdown">
                            <button class="dropdown-item deleteVendorAction" id="deleteVendorAction">Delete</button>
                        </div>
                                    </div> --}}
                            ...
                            &nbsp;
                                ...
                                <tbody class="list">
                                    <tr>
                                        {{-- <td>
                                            <div class="custom-control custom-checkbox table-checkbox">
                                                    <input type="checkbox" class="vendorIDs" value="{{ $vendor->id }}" name="vendor[]" id="vendorId">
                                            </div>
                                        </td> --}}

...
<div id="grad1">
  <div class="row rowstore">
    <br>
    <br>
  <div class="col-md-6 col-sm-12 col-xs-12 shopAbumatech-rectangle" style="background-color: {{ $store->color}}; height: 230px; color:#fff;">
    <p class="abumatech">{{ $store->name }}</p>
    <img src="{{ asset("storage/$store->logo")}}" alt="image" class="img-responsive img-fluid" style="position:absolute; height: 170px; margin-top: 30px; margin-left: 50px;">
    ...
    <div class="col-md-6  col-sm-12 col-xs-12 shopAbumatech-rectangle1" style="background-color: {{ $store->color}};height: 230px; color:#fff; padding-top:13px;>
    ...
    <p class="text4">{{ $store->opening_hours }} <span class="text5">{{ str_limit($store->description,20,'...')}}</span></p>
        ...
        <p class="text7"> {{ $store->phones }} 
          {{-- <span class="text8"> <i class="fas fa-star" style="color:white;  padding-left:170px;"></i><i class="fas fa-star" style="color:white; padding-left:8px;"></i><i class="far fa-star" style="color:white;  padding-left:8px;"></i> (Reviews from 400 users)</span> --}}
        </p>
